...
<div class="article">
    <p>
        Não é raro vermos noticiários na TV aberta relatando as filas intermináveis para atendimento, pacientes em
    ...
    <p>
        ...
        representa comparado ao PIB por cabeça de cada país.
    </p>
    <p>
        Isso sugere que o Brasil não aloca bem os recursos em saúde, pois gasta muito e mesmo assim tem um sistema de
        saúde que não atende boa parte da população. Deste modo, estratégias inteligentes para a organização do sistema
        de saúde serão fundamentais para o nosso futuro e para a maior eficácia do sistema de saúde. Então fica a
        pergunta, como poderemos ser mais eficientes? Como poderemos deixar esta colocação vexaminosa nos rankings de
        eficiência, no passado?
    </p>
    <b>Big Data auxiliando a saúde:</b>
    <p>
